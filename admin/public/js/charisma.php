...
function docReady() {
    ...
    $('.datatable').dataTable({
        ...
        "oLanguage": {
            "sLengthMenu": "_MENU_  &nbspObjets Par Page "
        }
    });
