...
<html>
  ...
  <br>
        ...
        <a href="public/images/logo_ent/<?php echo $res['image'];?>" class="fancybox_link"></a>
     ...
     <BR>
       ...
       <img src= "public/images/devis/<?php echo $res['image_dev'];?>" width="100">
          <?php echo $res['demande_devis'];?><br><br>
    <?php 
