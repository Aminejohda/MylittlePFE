...
<input type="hidden" id="long" name="long"/>
       ...
       <input type="text"  name="act" placeholder="Activité" id="country_id2" class="innn" onkeyup="autocomplet2()"autocomplete ="off" required style="width: 320px">       <ul id="country_list_id2"></ul>     
                  </span>
                  <span class="form_col">
    ...
    for( $i=0 ;$i<count($res); $i++){
     ...
     <div class='total_container' style = 'height: 21px;'>
              ...
              <ul class="list_type_11">
                <li style="background :url('public/images/blog_icon_03.png') no-repeat 91% 50%; color: #000; "><a href="voir_devis.php?id_dev=<?php echo $res[$i]['id_devis'] ;?>"><i class="icon_container" ></i><?php echo $res[$i]['sujet_devis']?></a><a href="voir_devis.php?id_dev=<?php echo $res[$i]['id_devis'] ;?>" style="float: right;"><?php echo count($res1) ;?></a></li>
              </ul>
